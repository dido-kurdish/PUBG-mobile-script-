...
prompt = gg.prompt({'⛔ ENTER THE PASSWORD!'},{[1]=0},{[1]='number'});

function right()
  gg.alert("Script By:😜dido__kurdish😜")
end
...
-----------------------------SECURITY CODE END-------------------------------
gg.alert("🎉 DIDO__KURDISH EDITION V5 VIP🎉")
function BP()
  gg.toast("DIDO__KURDISH V 0.14.0")
  gg.clearResults()
  gg.setRanges(131104)
...
function startBypass()
  gg.setVisible(false)
  bypassAlert = gg.alert("💥 Bypass (Anti-Crash) 💥", "𝗣𝗨𝗕𝗚 𝗠𝗢𝗕𝗜𝗟𝗘 0.𝟏4.0      ⟬N𝕆⟭ ", " ⟬𝕐𝔼𝕊⟭") if bypassAlert == 2 then BP() end
end
startBypass()
...
"➡️    insta📷:    dido__kurdish     ⬅️"},nil,"💢 𝐒𝐂𝐑𝐈𝐏𝐓 𝐏𝐔𝐁𝐆M VIP  💢 \n🇸🇾 DIDO__KURDISH SY 🇸🇾")
 if MN == nil then
  else
...
function CLOSE()
  print("🇸🇾 Script VIP By : dido__kurdish 🇸🇾")
  print("🇸🇾 Follow IG : @dido__kurdish🇸🇾")
  print("🇸🇾 YOUTUBE CHANNEL : DIDO__KURDISH🇸🇾")
  print("🇸🇾thank you ❤️ for using my SCRIPT🇸🇾")
  print(".")
  print(".")
  print(".")
  print("............GOOD💋BYE............")
